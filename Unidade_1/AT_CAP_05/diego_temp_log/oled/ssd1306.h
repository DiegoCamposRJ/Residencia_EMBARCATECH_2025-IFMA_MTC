...
extern void ssd1306_draw_char_scale2(uint8_t *ssd, int16_t x, int16_t y, uint8_t character);
extern void ssd1306_draw_string_scale2(uint8_t *ssd, int16_t x, int16_t y, const char *string);
